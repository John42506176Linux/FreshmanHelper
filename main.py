...
class MainPage(BaseHandler):
    ...
    def get(self):
        if self.user.logged_in:
            params = {
              'user_image_url':self.user.create_user_photo_url(),
...
class CreateProfilePage(BaseHandler,blobstore_handlers.BlobstoreUploadHandler):
    ...
    def get(self):
        ...
        upload_url = blobstore.create_upload_url('/create_profile')
    ...
    def post(self):
        ...
        self.request.get('Major ')
        self.request.get('Sport')
        self.request.get('Shows')
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route('/create_profile', handler=CreateProfilePage, name='CreateProfile'),
